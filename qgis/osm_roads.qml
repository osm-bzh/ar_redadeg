...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="name_br">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="group" forceraster="0" symbollevels="1" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="mainroad" label="mainroad"/>
      <category render="true" symbol="1" value="motorway" label="motorway"/>
      <category render="true" symbol="2" value="minorroad" label="minorroad"/>
      <category render="true" symbol="3" value="service" label="service"/>
      <category render="true" symbol="4" value="noauto" label="noauto"/>
      <category render="true" symbol="5" value="other" label="other"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="77,168,27,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="5">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="201,197,223,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="6">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="94,60,153,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="113,191,236,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <displayfield>name_fr</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="name_br" index="5" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="group"/>
      <column width="-1" hidden="0" type="field" name="name_fr"/>
      <column width="218" hidden="0" type="field" name="name_br"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="group" expression=""/>
    <default field="ref" expression=""/>
    <default field="name_fr" expression=""/>
    <default field="name_br" expression=""/>
  </defaults>
