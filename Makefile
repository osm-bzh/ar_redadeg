...
run_vm: $(UBUNTU_DISK)
	qemu-system-x86_64 -drive file=./ubuntu.qcow2,format=qcow2 -m 8G -cpu host -smp sockets=1,cores=2,threads=2 -enable-kvm -nic user,hostfwd=tcp::8822-:22,hostfwd=tcp::8880-:8080
